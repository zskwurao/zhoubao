...
public class ArticleController {
	...
	@ResponseBody
	public WeeklyResult addArticle(@RequestBody Map map) {
		
		// 
		Article article = new Article();
		article.setId(Integer.parseInt(map.get("id").toString()));
		...
		article.setTxt(map.get("txt").toString());
		article.setuId(map.get("uId").toString());
